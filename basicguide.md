...
Both these options ensure that even in a potential breach, attackers would not be able to view or use any form response data. 

## My form responses are lost! Can you help us recover them?

If you lose your secret key (Storage mode) or email response data (Email mode), we are unable to recover your lost data, as we do not store secret keys or unencrypted response data for security purposes.

Here are [some steps you can take to avoid accidentally losing your secret keys](link).
